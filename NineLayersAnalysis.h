...
// Sat Feb  6 14:26:24 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_9layers.root
//////////////////////////////////////////////////////////

#ifndef NineLayersAnalysis_h
#define NineLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1103168;
   ...
   NineLayersAnalysis(TTree *tree=0);
   virtual ~NineLayersAnalysis();
...
#ifdef NineLayersAnalysis_cxx
NineLayersAnalysis::NineLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_9layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_9layers.root");
      }
...
NineLayersAnalysis::~NineLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NineLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NineLayersAnalysis::LoadTree(Long64_t entry)
{
...
void NineLayersAnalysis::Init(TTree *tree)
{
...
Bool_t NineLayersAnalysis::Notify()
{
...
void NineLayersAnalysis::Show(Long64_t entry)
{
...
Int_t NineLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef NineLayersAnalysis_cxx
