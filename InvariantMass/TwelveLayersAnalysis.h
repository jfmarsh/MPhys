...
// Sat Feb  6 14:27:18 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayersAnalysis_h
#define TwelveLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1467136;
   static constexpr Int_t kMaxCaloClusters = 3;
   ...
   TwelveLayersAnalysis(TTree *tree=0);
   virtual ~TwelveLayersAnalysis();
...
#ifdef TwelveLayersAnalysis_cxx
TwelveLayersAnalysis::TwelveLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers.root");
      }
...
TwelveLayersAnalysis::~TwelveLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayersAnalysis::LoadTree(Long64_t entry)
{
...
void TwelveLayersAnalysis::Init(TTree *tree)
{
...
Bool_t TwelveLayersAnalysis::Notify()
{
...
void TwelveLayersAnalysis::Show(Long64_t entry)
{
...
Int_t TwelveLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayersAnalysis_cxx
