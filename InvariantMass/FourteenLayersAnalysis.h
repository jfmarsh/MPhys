...
// Sat Feb  6 14:28:44 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayersAnalysis_h
#define FourteenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1707904;
   ...
   FourteenLayersAnalysis(TTree *tree=0);
   virtual ~FourteenLayersAnalysis();
...
#ifdef FourteenLayersAnalysis_cxx
FourteenLayersAnalysis::FourteenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_14layers.root");
      }
...
FourteenLayersAnalysis::~FourteenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void FourteenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t FourteenLayersAnalysis::Notify()
{
...
void FourteenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t FourteenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayersAnalysis_cxx
