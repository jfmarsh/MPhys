...
// Tue Feb  9 11:55:18 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_17layers.root
//////////////////////////////////////////////////////////

#ifndef SeventeenLayersAnalysis_h
#define SeventeenLayersAnalysis_h
...
class SeventeenLayersAnalysis {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 4759;
   static constexpr Int_t kMaxemptyCaloCells = 1;
   static constexpr Int_t kMaxmergedECalCellsNoise = 2069056;
   static constexpr Int_t kMaxCaloClusters = 5;
   static constexpr Int_t kMaxCaloClusters0 = 1;
   static constexpr Int_t kMaxECalBarrelCells = 4759;
   static constexpr Int_t kMaxGenParticles = 9;
   static constexpr Int_t kMaxGenParticles0 = 9;
   static constexpr Int_t kMaxGenParticles1 = 9;
   ...
   SeventeenLayersAnalysis(TTree *tree=0);
   virtual ~SeventeenLayersAnalysis();
...
#ifdef SeventeenLayersAnalysis_cxx
SeventeenLayersAnalysis::SeventeenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_17layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_17layers.root");
      }
...
SeventeenLayersAnalysis::~SeventeenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SeventeenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SeventeenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void SeventeenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t SeventeenLayersAnalysis::Notify()
{
...
void SeventeenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t SeventeenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SeventeenLayersAnalysis_cxx
