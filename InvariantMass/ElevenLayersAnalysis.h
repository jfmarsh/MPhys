...
// Sat Feb  6 14:26:51 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_11layers.root
//////////////////////////////////////////////////////////

#ifndef ElevenLayersAnalysis_h
#define ElevenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1346752;
   static constexpr Int_t kMaxCaloClusters = 4;
   ...
   ElevenLayersAnalysis(TTree *tree=0);
   virtual ~ElevenLayersAnalysis();
...
#ifdef ElevenLayersAnalysis_cxx
ElevenLayersAnalysis::ElevenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_11layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_11layers.root");
      }
...
ElevenLayersAnalysis::~ElevenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ElevenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ElevenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void ElevenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t ElevenLayersAnalysis::Notify()
{
...
void ElevenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t ElevenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef ElevenLayersAnalysis_cxx
