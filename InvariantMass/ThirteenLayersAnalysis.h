...
// Sat Feb  6 14:28:18 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_13layers.root
//////////////////////////////////////////////////////////

#ifndef ThirteenLayersAnalysis_h
#define ThirteenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1587520;
   ...
   ThirteenLayersAnalysis(TTree *tree=0);
   virtual ~ThirteenLayersAnalysis();
...
#ifdef ThirteenLayersAnalysis_cxx
ThirteenLayersAnalysis::ThirteenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_13layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_13layers.root");
      }
...
ThirteenLayersAnalysis::~ThirteenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ThirteenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ThirteenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void ThirteenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t ThirteenLayersAnalysis::Notify()
{
...
void ThirteenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t ThirteenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef ThirteenLayersAnalysis_cxx
