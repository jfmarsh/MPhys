...
// Mon Feb  8 17:18:56 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_16layers.root
//////////////////////////////////////////////////////////

#ifndef SixteenLayersAnalysis_h
#define SixteenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1948672;
   static constexpr Int_t kMaxCaloClusters = 9;
   ...
   SixteenLayersAnalysis(TTree *tree=0);
   virtual ~SixteenLayersAnalysis();
...
#ifdef SixteenLayersAnalysis_cxx
SixteenLayersAnalysis::SixteenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_16layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_16layers.root");
      }
...
SixteenLayersAnalysis::~SixteenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SixteenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SixteenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void SixteenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t SixteenLayersAnalysis::Notify()
{
...
void SixteenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t SixteenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SixteenLayersAnalysis_cxx
