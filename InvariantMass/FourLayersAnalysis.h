...
// Fri Feb  5 17:40:16 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers.root
//////////////////////////////////////////////////////////

#ifndef FourLayersAnalysis_h
#define FourLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 494208;
   ...
   FourLayersAnalysis(TTree *tree=0);
   virtual ~FourLayersAnalysis();
...
#ifdef FourLayersAnalysis_cxx
FourLayersAnalysis::FourLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers.root");
      }
...
FourLayersAnalysis::~FourLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayersAnalysis::LoadTree(Long64_t entry)
{
...
void FourLayersAnalysis::Init(TTree *tree)
{
...
Bool_t FourLayersAnalysis::Notify()
{
...
void FourLayersAnalysis::Show(Long64_t entry)
{
...
Int_t FourLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayersAnalysis_cxx
