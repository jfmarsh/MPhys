...
// Sat Feb  6 14:25:46 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers.root
//////////////////////////////////////////////////////////

#ifndef EightLayersAnalysis_h
#define EightLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 981376;
   ...
   EightLayersAnalysis(TTree *tree=0);
   virtual ~EightLayersAnalysis();
...
#ifdef EightLayersAnalysis_cxx
EightLayersAnalysis::EightLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers.root");
      }
...
EightLayersAnalysis::~EightLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayersAnalysis::LoadTree(Long64_t entry)
{
...
void EightLayersAnalysis::Init(TTree *tree)
{
...
Bool_t EightLayersAnalysis::Notify()
{
...
void EightLayersAnalysis::Show(Long64_t entry)
{
...
Int_t EightLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayersAnalysis_cxx
