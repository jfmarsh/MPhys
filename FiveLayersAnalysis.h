...
// Fri Feb  5 17:46:58 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_5layers.root
//////////////////////////////////////////////////////////

#ifndef FiveLayersAnalysis_h
#define FiveLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 616000;
   ...
   FiveLayersAnalysis(TTree *tree=0);
   virtual ~FiveLayersAnalysis();
...
#ifdef FiveLayersAnalysis_cxx
FiveLayersAnalysis::FiveLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_5layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_5layers.root");
      }
...
FiveLayersAnalysis::~FiveLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FiveLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FiveLayersAnalysis::LoadTree(Long64_t entry)
{
...
void FiveLayersAnalysis::Init(TTree *tree)
{
...
Bool_t FiveLayersAnalysis::Notify()
{
...
void FiveLayersAnalysis::Show(Long64_t entry)
{
...
Int_t FiveLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef FiveLayersAnalysis_cxx
