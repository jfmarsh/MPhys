...
// Sat Feb  6 14:29:58 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_7layers.root
//////////////////////////////////////////////////////////

#ifndef SevenLayersAnalysis_h
#define SevenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 859584;
   ...
   SevenLayersAnalysis(TTree *tree=0);
   virtual ~SevenLayersAnalysis();
...
#ifdef SevenLayersAnalysis_cxx
SevenLayersAnalysis::SevenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_7layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_7layers.root");
      }
...
SevenLayersAnalysis::~SevenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SevenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SevenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void SevenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t SevenLayersAnalysis::Notify()
{
...
void SevenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t SevenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SevenLayersAnalysis_cxx
