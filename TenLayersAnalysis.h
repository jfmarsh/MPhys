...
// Fri Feb  5 17:59:11 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_10layers.root
//////////////////////////////////////////////////////////

#ifndef TenLayersAnalysis_h
#define TenLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1224960;
   ...
   TenLayersAnalysis(TTree *tree=0);
   virtual ~TenLayersAnalysis();
...
#ifdef TenLayersAnalysis_cxx
TenLayersAnalysis::TenLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_10layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_10layers.root");
      }
...
TenLayersAnalysis::~TenLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TenLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TenLayersAnalysis::LoadTree(Long64_t entry)
{
...
void TenLayersAnalysis::Init(TTree *tree)
{
...
Bool_t TenLayersAnalysis::Notify()
{
...
void TenLayersAnalysis::Show(Long64_t entry)
{
...
Int_t TenLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef TenLayersAnalysis_cxx
