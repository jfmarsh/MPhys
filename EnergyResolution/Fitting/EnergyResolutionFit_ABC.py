...
gr.SetLineColor(4)
# fit 
f1 = TF1("f1","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f1.SetParameter(0,1)
...
gr2.SetLineColor(6)
# fit
f2 = TF1("f2","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f2.SetParameter(0,1)
...
gr3.SetLineColor(80)
# fit
f3 = TF1("f3","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f3.SetParameter(0,1)
...
gr4.SetLineColor(2)
# fit
f4 = TF1("f4","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f4.SetParameter(0,1)
...
gr5.SetLineColor(65)
# fit
f5 = TF1("f5","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f5.SetParameter(0,1)
...
gr6.SetLineColor(90)
# fit
f6 = TF1("f6","sqrt([0]**2/x + [1]**2/x**2 + [2]**2)",0,400)
f6.SetParameter(0,1)
...
c1.SaveAs("FitResults/EnergyResolutionFit_ABC_25to400GeV.pdf")
...
with open('FitResults/EnergyResolutionFitResults_ABC_25to400GeV.txt', 'w') as f:
    print(fitResults_layer, file=f) 
f.close

with open('FitResults/EnergyResolutionFitErrors_ABC_25to400GeV.txt', 'w') as f:
...
legend.Draw()
c2.Draw()
c2.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_4layers.pdf")
...
f2.SetLineColor( 6 )
result2 = gr2.Fit(f2, "SQR")
gr2.SetTitle( 'Energy Resolution' )
...
legend2.Draw()
c3.Draw()
c3.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_8layers.pdf")
...
f3.SetLineColor( 80 )
result3 = gr3.Fit(f3, "SQR")
gr3.SetTitle( 'Energy Resolution' )
...
legend3.Draw()
c4.Draw()
c4.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_12layers.pdf")
...
f6.SetLineColor( 90 )
result6 = gr6.Fit(f6, "SQR")
gr6.SetTitle( 'Energy Resolution' )
...
legend6.Draw()
c5.Draw()
c5.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_14layers.pdf")
...
f4.SetLineColor( 2 )
result4 = gr4.Fit(f4, "SQR")
gr4.SetTitle( 'Energy Resolution' )
...
legend4.Draw()
c6.Draw()
c6.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_15layers.pdf")
...
f5.SetLineColor( 65 )
result5 = gr5.Fit(f5, "SQR")
gr5.SetTitle( 'Energy Resolution' )
...
legend5.Draw()
c7.Draw()
c7.SaveAs("FitGraphs/EnergyResolutionFit_25to400GeV_20layers.pdf")