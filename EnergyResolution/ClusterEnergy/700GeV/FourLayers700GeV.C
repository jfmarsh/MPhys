#define FourLayers700GeV_cxx
#include "FourLayers700GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
{  // CALO ANALYSIS 
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 700 GeV Electron Beam (4 Layers); Energy [GeV]; #Events",150,0,750);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_700GeV_4Layers.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_700GeV_4layers.pdf");
