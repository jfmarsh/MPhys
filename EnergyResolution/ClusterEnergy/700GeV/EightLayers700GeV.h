...
// Sun Mar  7 20:27:19 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_700GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers700GeV_h
#define EightLayers700GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers700GeV(TTree *tree=0);
   virtual ~EightLayers700GeV();
...
#ifdef EightLayers700GeV_cxx
EightLayers700GeV::EightLayers700GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_700GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_700GeV.root");
      }
...
EightLayers700GeV::~EightLayers700GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers700GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers700GeV::LoadTree(Long64_t entry)
{
...
void EightLayers700GeV::Init(TTree *tree)
{
...
Bool_t EightLayers700GeV::Notify()
{
...
void EightLayers700GeV::Show(Long64_t entry)
{
...
Int_t EightLayers700GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers700GeV_cxx
