...
// Sun Mar  7 20:26:59 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_700GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers700GeV_h
#define FourLayers700GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers700GeV(TTree *tree=0);
   virtual ~FourLayers700GeV();
...
#ifdef FourLayers700GeV_cxx
FourLayers700GeV::FourLayers700GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_700GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_700GeV.root");
      }
...
FourLayers700GeV::~FourLayers700GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers700GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers700GeV::LoadTree(Long64_t entry)
{
...
void FourLayers700GeV::Init(TTree *tree)
{
...
Bool_t FourLayers700GeV::Notify()
{
...
void FourLayers700GeV::Show(Long64_t entry)
{
...
Int_t FourLayers700GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers700GeV_cxx
