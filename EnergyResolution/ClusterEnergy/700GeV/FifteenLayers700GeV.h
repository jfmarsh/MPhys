...
// Sun Mar  7 20:39:05 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_700GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers700GeV_h
#define FifteenLayers700GeV_h
...
class FifteenLayers700GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 9699;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 9699;
   ...
   FifteenLayers700GeV(TTree *tree=0);
   virtual ~FifteenLayers700GeV();
...
#ifdef FifteenLayers700GeV_cxx
FifteenLayers700GeV::FifteenLayers700GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_700GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_700GeV.root");
      }
...
FifteenLayers700GeV::~FifteenLayers700GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers700GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers700GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers700GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers700GeV::Notify()
{
...
void FifteenLayers700GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers700GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers700GeV_cxx
