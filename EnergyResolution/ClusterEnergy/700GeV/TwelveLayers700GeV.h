...
// Sun Mar  7 20:27:46 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_700GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers700GeV_h
#define TwelveLayers700GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers700GeV(TTree *tree=0);
   virtual ~TwelveLayers700GeV();
...
#ifdef TwelveLayers700GeV_cxx
TwelveLayers700GeV::TwelveLayers700GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_700GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_700GeV.root");
      }
...
TwelveLayers700GeV::~TwelveLayers700GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers700GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers700GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers700GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers700GeV::Notify()
{
...
void TwelveLayers700GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers700GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers700GeV_cxx
