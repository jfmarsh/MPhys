...
// Tue Mar  2 18:52:18 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_800GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers800GeV_h
#define FifteenLayers800GeV_h
...
class FifteenLayers800GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 10391;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 10391;
   ...
   FifteenLayers800GeV(TTree *tree=0);
   virtual ~FifteenLayers800GeV();
...
#ifdef FifteenLayers800GeV_cxx
FifteenLayers800GeV::FifteenLayers800GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_800GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_800GeV.root");
      }
...
FifteenLayers800GeV::~FifteenLayers800GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers800GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers800GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers800GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers800GeV::Notify()
{
...
void FifteenLayers800GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers800GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers800GeV_cxx
