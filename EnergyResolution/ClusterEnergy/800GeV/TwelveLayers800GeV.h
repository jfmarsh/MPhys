...
// Tue Mar  2 18:38:26 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_800GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers800GeV_h
#define TwelveLayers800GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers800GeV(TTree *tree=0);
   virtual ~TwelveLayers800GeV();
...
#ifdef TwelveLayers800GeV_cxx
TwelveLayers800GeV::TwelveLayers800GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_800GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_800GeV.root");
      }
...
TwelveLayers800GeV::~TwelveLayers800GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers800GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers800GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers800GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers800GeV::Notify()
{
...
void TwelveLayers800GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers800GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers800GeV_cxx
