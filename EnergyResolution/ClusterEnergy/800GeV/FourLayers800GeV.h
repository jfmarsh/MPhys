...
// Tue Mar  2 18:20:16 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_800GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers800GeV_h
#define FourLayers800GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers800GeV(TTree *tree=0);
   virtual ~FourLayers800GeV();
...
#ifdef FourLayers800GeV_cxx
FourLayers800GeV::FourLayers800GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_800GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_800GeV.root");
      }
...
FourLayers800GeV::~FourLayers800GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers800GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers800GeV::LoadTree(Long64_t entry)
{
...
void FourLayers800GeV::Init(TTree *tree)
{
...
Bool_t FourLayers800GeV::Notify()
{
...
void FourLayers800GeV::Show(Long64_t entry)
{
...
Int_t FourLayers800GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers800GeV_cxx
