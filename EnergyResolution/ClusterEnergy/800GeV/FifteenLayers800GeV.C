#define FifteenLayers800GeV_cxx
#include "FifteenLayers800GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
{  // CALO ANALYSIS 
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 800 GeV Electron Beam (15 Layers); Energy [GeV]; #Clusters",150,400,850);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_800GeV_15Layers_BOUND.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_800GeV_15layers_BOUND.pdf");
