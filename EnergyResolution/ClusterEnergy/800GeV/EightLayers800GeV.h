...
// Tue Mar  2 18:29:32 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_800GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers800GeV_h
#define EightLayers800GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers800GeV(TTree *tree=0);
   virtual ~EightLayers800GeV();
...
#ifdef EightLayers800GeV_cxx
EightLayers800GeV::EightLayers800GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_800GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_800GeV.root");
      }
...
EightLayers800GeV::~EightLayers800GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers800GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers800GeV::LoadTree(Long64_t entry)
{
...
void EightLayers800GeV::Init(TTree *tree)
{
...
Bool_t EightLayers800GeV::Notify()
{
...
void EightLayers800GeV::Show(Long64_t entry)
{
...
Int_t EightLayers800GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers800GeV_cxx
