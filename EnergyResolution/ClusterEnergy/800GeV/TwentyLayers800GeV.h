...
// Tue Mar  2 19:12:15 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_800GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers800GeV_h
#define TwentyLayers800GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers800GeV(TTree *tree=0);
   virtual ~TwentyLayers800GeV();
...
#ifdef TwentyLayers800GeV_cxx
TwentyLayers800GeV::TwentyLayers800GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_800GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_800GeV.root");
      }
...
TwentyLayers800GeV::~TwentyLayers800GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers800GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers800GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers800GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers800GeV::Notify()
{
...
void TwentyLayers800GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers800GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers800GeV_cxx
