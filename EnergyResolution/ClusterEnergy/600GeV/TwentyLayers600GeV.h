...
// Sun Mar  7 16:05:13 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_600GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers600GeV_h
#define TwentyLayers600GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers600GeV(TTree *tree=0);
   virtual ~TwentyLayers600GeV();
...
#ifdef TwentyLayers600GeV_cxx
TwentyLayers600GeV::TwentyLayers600GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_600GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_600GeV.root");
      }
...
TwentyLayers600GeV::~TwentyLayers600GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers600GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers600GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers600GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers600GeV::Notify()
{
...
void TwentyLayers600GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers600GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers600GeV_cxx
