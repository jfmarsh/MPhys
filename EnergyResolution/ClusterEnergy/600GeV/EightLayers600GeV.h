...
// Sun Mar  7 16:04:25 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_600GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers600GeV_h
#define EightLayers600GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers600GeV(TTree *tree=0);
   virtual ~EightLayers600GeV();
...
#ifdef EightLayers600GeV_cxx
EightLayers600GeV::EightLayers600GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_600GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_600GeV.root");
      }
...
EightLayers600GeV::~EightLayers600GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers600GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers600GeV::LoadTree(Long64_t entry)
{
...
void EightLayers600GeV::Init(TTree *tree)
{
...
Bool_t EightLayers600GeV::Notify()
{
...
void EightLayers600GeV::Show(Long64_t entry)
{
...
Int_t EightLayers600GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers600GeV_cxx
