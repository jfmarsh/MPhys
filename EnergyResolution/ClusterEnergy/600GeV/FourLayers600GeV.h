...
// Sun Mar  7 16:04:07 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_600GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers600GeV_h
#define FourLayers600GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers600GeV(TTree *tree=0);
   virtual ~FourLayers600GeV();
...
#ifdef FourLayers600GeV_cxx
FourLayers600GeV::FourLayers600GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_600GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_600GeV.root");
      }
...
FourLayers600GeV::~FourLayers600GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers600GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers600GeV::LoadTree(Long64_t entry)
{
...
void FourLayers600GeV::Init(TTree *tree)
{
...
Bool_t FourLayers600GeV::Notify()
{
...
void FourLayers600GeV::Show(Long64_t entry)
{
...
Int_t FourLayers600GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers600GeV_cxx
