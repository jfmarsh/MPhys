...
// Sun Mar  7 16:04:48 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_600GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers600GeV_h
#define FifteenLayers600GeV_h
...
class FifteenLayers600GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 9154;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 9154;
   ...
   FifteenLayers600GeV(TTree *tree=0);
   virtual ~FifteenLayers600GeV();
...
#ifdef FifteenLayers600GeV_cxx
FifteenLayers600GeV::FifteenLayers600GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_600GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_600GeV.root");
      }
...
FifteenLayers600GeV::~FifteenLayers600GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers600GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers600GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers600GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers600GeV::Notify()
{
...
void FifteenLayers600GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers600GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers600GeV_cxx
