...
// Thu Mar 11 16:58:19 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_20layers.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers350GeV_h
#define TwentyLayers350GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers350GeV(TTree *tree=0);
   virtual ~TwentyLayers350GeV();
...
#ifdef TwentyLayers350GeV_cxx
TwentyLayers350GeV::TwentyLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_20layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_20layers.root");
      }
...
TwentyLayers350GeV::~TwentyLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers350GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers350GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers350GeV::Notify()
{
...
void TwentyLayers350GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers350GeV_cxx
