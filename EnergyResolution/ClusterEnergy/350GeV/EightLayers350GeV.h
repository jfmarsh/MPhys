...
// Thu Mar 11 16:57:27 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_8layers.root
//////////////////////////////////////////////////////////

#ifndef EightLayers350GeV_h
#define EightLayers350GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers350GeV(TTree *tree=0);
   virtual ~EightLayers350GeV();
...
#ifdef EightLayers350GeV_cxx
EightLayers350GeV::EightLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_8layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_8layers.root");
      }
...
EightLayers350GeV::~EightLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers350GeV::LoadTree(Long64_t entry)
{
...
void EightLayers350GeV::Init(TTree *tree)
{
...
Bool_t EightLayers350GeV::Notify()
{
...
void EightLayers350GeV::Show(Long64_t entry)
{
...
Int_t EightLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers350GeV_cxx
