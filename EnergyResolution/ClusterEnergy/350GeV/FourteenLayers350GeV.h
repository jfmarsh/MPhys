...
// Sat Mar 13 14:11:02 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers350GeV_h
#define FourteenLayers350GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers350GeV(TTree *tree=0);
   virtual ~FourteenLayers350GeV();
...
#ifdef FourteenLayers350GeV_cxx
FourteenLayers350GeV::FourteenLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_14layers.root");
      }
...
FourteenLayers350GeV::~FourteenLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers350GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers350GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers350GeV::Notify()
{
...
void FourteenLayers350GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers350GeV_cxx
