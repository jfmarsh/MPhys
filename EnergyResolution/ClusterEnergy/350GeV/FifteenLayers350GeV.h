...
// Thu Mar 11 16:58:02 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_15layers.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers350GeV_h
#define FifteenLayers350GeV_h
...
class FifteenLayers350GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 7138;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 7138;
   ...
   FifteenLayers350GeV(TTree *tree=0);
   virtual ~FifteenLayers350GeV();
...
#ifdef FifteenLayers350GeV_cxx
FifteenLayers350GeV::FifteenLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_15layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_15layers.root");
      }
...
FifteenLayers350GeV::~FifteenLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers350GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers350GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers350GeV::Notify()
{
...
void FifteenLayers350GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers350GeV_cxx
