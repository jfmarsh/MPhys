...
// Thu Mar 11 17:02:23 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_4layers.root
//////////////////////////////////////////////////////////

#ifndef FourLayers350GeV_h
#define FourLayers350GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers350GeV(TTree *tree=0);
   virtual ~FourLayers350GeV();
...
#ifdef FourLayers350GeV_cxx
FourLayers350GeV::FourLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_4layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_4layers.root");
      }
...
FourLayers350GeV::~FourLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers350GeV::LoadTree(Long64_t entry)
{
...
void FourLayers350GeV::Init(TTree *tree)
{
...
Bool_t FourLayers350GeV::Notify()
{
...
void FourLayers350GeV::Show(Long64_t entry)
{
...
Int_t FourLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers350GeV_cxx
