...
// Thu Mar 11 16:57:45 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_350GeV_12layers.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers350GeV_h
#define TwelveLayers350GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers350GeV(TTree *tree=0);
   virtual ~TwelveLayers350GeV();
...
#ifdef TwelveLayers350GeV_cxx
TwelveLayers350GeV::TwelveLayers350GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_350GeV_12layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_350GeV_12layers.root");
      }
...
TwelveLayers350GeV::~TwelveLayers350GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers350GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers350GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers350GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers350GeV::Notify()
{
...
void TwelveLayers350GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers350GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers350GeV_cxx
