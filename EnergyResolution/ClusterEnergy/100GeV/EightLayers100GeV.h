...
// Mon Mar  1 12:40:40 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_100GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers100GeV_h
#define EightLayers100GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers100GeV(TTree *tree=0);
   virtual ~EightLayers100GeV();
...
#ifdef EightLayers100GeV_cxx
EightLayers100GeV::EightLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_100GeV.root");
      }
...
EightLayers100GeV::~EightLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers100GeV::LoadTree(Long64_t entry)
{
...
void EightLayers100GeV::Init(TTree *tree)
{
...
Bool_t EightLayers100GeV::Notify()
{
...
void EightLayers100GeV::Show(Long64_t entry)
{
...
Int_t EightLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers100GeV_cxx
