...
// Sat Mar 13 14:04:39 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_100GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers100GeV_h
#define FourteenLayers100GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers100GeV(TTree *tree=0);
   virtual ~FourteenLayers100GeV();
...
#ifdef FourteenLayers100GeV_cxx
FourteenLayers100GeV::FourteenLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_100GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_100GeV_14layers.root");
      }
...
FourteenLayers100GeV::~FourteenLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers100GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers100GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers100GeV::Notify()
{
...
void FourteenLayers100GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers100GeV_cxx
