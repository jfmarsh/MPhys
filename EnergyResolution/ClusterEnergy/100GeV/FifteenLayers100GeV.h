...
// Mon Mar  1 12:41:37 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_100GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers100GeV_h
#define FifteenLayers100GeV_h
...
class FifteenLayers100GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 3507;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 3507;
   ...
   FifteenLayers100GeV(TTree *tree=0);
   virtual ~FifteenLayers100GeV();
...
#ifdef FifteenLayers100GeV_cxx
FifteenLayers100GeV::FifteenLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_100GeV.root");
      }
...
FifteenLayers100GeV::~FifteenLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers100GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers100GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers100GeV::Notify()
{
...
void FifteenLayers100GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers100GeV_cxx
