...
// Mon Mar  1 12:42:03 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_100GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers100GeV_h
#define TwentyLayers100GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers100GeV(TTree *tree=0);
   virtual ~TwentyLayers100GeV();
...
#ifdef TwentyLayers100GeV_cxx
TwentyLayers100GeV::TwentyLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_100GeV.root");
      }
...
TwentyLayers100GeV::~TwentyLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers100GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers100GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers100GeV::Notify()
{
...
void TwentyLayers100GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers100GeV_cxx
