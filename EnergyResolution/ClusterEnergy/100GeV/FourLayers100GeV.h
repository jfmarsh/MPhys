...
// Mon Mar  1 12:32:23 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_100GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers100GeV_h
#define FourLayers100GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers100GeV(TTree *tree=0);
   virtual ~FourLayers100GeV();
...
#ifdef FourLayers100GeV_cxx
FourLayers100GeV::FourLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_100GeV.root");
      }
...
FourLayers100GeV::~FourLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers100GeV::LoadTree(Long64_t entry)
{
...
void FourLayers100GeV::Init(TTree *tree)
{
...
Bool_t FourLayers100GeV::Notify()
{
...
void FourLayers100GeV::Show(Long64_t entry)
{
...
Int_t FourLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers100GeV_cxx
