...
// Mon Mar  1 12:41:17 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_100GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers100GeV_h
#define TwelveLayers100GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers100GeV(TTree *tree=0);
   virtual ~TwelveLayers100GeV();
...
#ifdef TwelveLayers100GeV_cxx
TwelveLayers100GeV::TwelveLayers100GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_100GeV.root");
      }
...
TwelveLayers100GeV::~TwelveLayers100GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers100GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers100GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers100GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers100GeV::Notify()
{
...
void TwelveLayers100GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers100GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers100GeV_cxx
