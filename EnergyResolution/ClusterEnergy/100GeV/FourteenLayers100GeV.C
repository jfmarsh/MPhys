#define FourteenLayers100GeV_cxx
#include "FourteenLayers100GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void FourteenLayers100GeV::Loop()
{  // CALO ANALYSIS 
   if (fChain == 0) return;
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 100 GeV Electron Beam (14 Layers); Energy [GeV]; #Events",150,0,120);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_100GeV_14Layers.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_100GeV_14layers.pdf");
