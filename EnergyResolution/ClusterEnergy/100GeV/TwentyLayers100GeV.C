#define TwentyLayers100GeV_cxx
#include "TwentyLayers100GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
{  // CALO ANALYSIS 
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 100 GeV Electron Beam (20 Layers); Energy [GeV]; #Clusters",150,0,120);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_100GeV_20Layers.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_100GeV_20layers.pdf");
