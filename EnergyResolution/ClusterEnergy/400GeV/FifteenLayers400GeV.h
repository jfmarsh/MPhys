...
// Tue Mar  2 14:46:45 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_400GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers400GeV_h
#define FifteenLayers400GeV_h
...
class FifteenLayers400GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 7784;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 7784;
   ...
   FifteenLayers400GeV(TTree *tree=0);
   virtual ~FifteenLayers400GeV();
...
#ifdef FifteenLayers400GeV_cxx
FifteenLayers400GeV::FifteenLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_400GeV.root");
      }
...
FifteenLayers400GeV::~FifteenLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers400GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers400GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers400GeV::Notify()
{
...
void FifteenLayers400GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers400GeV_cxx
