...
// Sat Mar 13 16:46:46 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_400GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers400GeV_h
#define FourteenLayers400GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers400GeV(TTree *tree=0);
   virtual ~FourteenLayers400GeV();
...
#ifdef FourteenLayers400GeV_cxx
FourteenLayers400GeV::FourteenLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_400GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_400GeV_14layers.root");
      }
...
FourteenLayers400GeV::~FourteenLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers400GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers400GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers400GeV::Notify()
{
...
void FourteenLayers400GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers400GeV_cxx
