...
// Tue Mar  2 14:49:43 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_400GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers400GeV_h
#define FourLayers400GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers400GeV(TTree *tree=0);
   virtual ~FourLayers400GeV();
...
#ifdef FourLayers400GeV_cxx
FourLayers400GeV::FourLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_400GeV.root");
      }
...
FourLayers400GeV::~FourLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers400GeV::LoadTree(Long64_t entry)
{
...
void FourLayers400GeV::Init(TTree *tree)
{
...
Bool_t FourLayers400GeV::Notify()
{
...
void FourLayers400GeV::Show(Long64_t entry)
{
...
Int_t FourLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers400GeV_cxx
