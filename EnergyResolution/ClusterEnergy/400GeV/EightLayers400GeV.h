...
// Tue Mar  2 14:45:53 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_400GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers400GeV_h
#define EightLayers400GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers400GeV(TTree *tree=0);
   virtual ~EightLayers400GeV();
...
#ifdef EightLayers400GeV_cxx
EightLayers400GeV::EightLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_400GeV.root");
      }
...
EightLayers400GeV::~EightLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers400GeV::LoadTree(Long64_t entry)
{
...
void EightLayers400GeV::Init(TTree *tree)
{
...
Bool_t EightLayers400GeV::Notify()
{
...
void EightLayers400GeV::Show(Long64_t entry)
{
...
Int_t EightLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers400GeV_cxx
