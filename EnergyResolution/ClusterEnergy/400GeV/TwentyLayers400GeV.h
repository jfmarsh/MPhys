...
// Tue Mar  2 14:47:05 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_400GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers400GeV_h
#define TwentyLayers400GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers400GeV(TTree *tree=0);
   virtual ~TwentyLayers400GeV();
...
#ifdef TwentyLayers400GeV_cxx
TwentyLayers400GeV::TwentyLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_400GeV.root");
      }
...
TwentyLayers400GeV::~TwentyLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers400GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers400GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers400GeV::Notify()
{
...
void TwentyLayers400GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers400GeV_cxx
