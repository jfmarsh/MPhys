...
// Tue Mar  2 14:46:26 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_400GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers400GeV_h
#define TwelveLayers400GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers400GeV(TTree *tree=0);
   virtual ~TwelveLayers400GeV();
...
#ifdef TwelveLayers400GeV_cxx
TwelveLayers400GeV::TwelveLayers400GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_400GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_400GeV.root");
      }
...
TwelveLayers400GeV::~TwelveLayers400GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers400GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers400GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers400GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers400GeV::Notify()
{
...
void TwelveLayers400GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers400GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers400GeV_cxx
