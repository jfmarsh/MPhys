...
// Sat Mar 13 14:00:28 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_50GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers50GeV_h
#define FourteenLayers50GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers50GeV(TTree *tree=0);
   virtual ~FourteenLayers50GeV();
...
#ifdef FourteenLayers50GeV_cxx
FourteenLayers50GeV::FourteenLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_50GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_50GeV_14layers.root");
      }
...
FourteenLayers50GeV::~FourteenLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers50GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers50GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers50GeV::Notify()
{
...
void FourteenLayers50GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers50GeV_cxx
