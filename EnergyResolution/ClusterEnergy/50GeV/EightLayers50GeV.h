...
// Mon Mar  1 18:05:33 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_50GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers50GeV_h
#define EightLayers50GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers50GeV(TTree *tree=0);
   virtual ~EightLayers50GeV();
...
#ifdef EightLayers50GeV_cxx
EightLayers50GeV::EightLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_50GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_50GeV.root");
      }
...
EightLayers50GeV::~EightLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers50GeV::LoadTree(Long64_t entry)
{
...
void EightLayers50GeV::Init(TTree *tree)
{
...
Bool_t EightLayers50GeV::Notify()
{
...
void EightLayers50GeV::Show(Long64_t entry)
{
...
Int_t EightLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers50GeV_cxx
