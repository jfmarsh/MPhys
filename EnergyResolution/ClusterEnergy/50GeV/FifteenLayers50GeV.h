...
// Mon Mar  1 18:06:15 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_50GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers50GeV_h
#define FifteenLayers50GeV_h
...
class FifteenLayers50GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 2339;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 2339;
   ...
   FifteenLayers50GeV(TTree *tree=0);
   virtual ~FifteenLayers50GeV();
...
#ifdef FifteenLayers50GeV_cxx
FifteenLayers50GeV::FifteenLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_50GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_50GeV.root");
      }
...
FifteenLayers50GeV::~FifteenLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers50GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers50GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers50GeV::Notify()
{
...
void FifteenLayers50GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers50GeV_cxx
