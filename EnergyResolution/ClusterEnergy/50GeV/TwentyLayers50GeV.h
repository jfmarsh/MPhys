...
// Mon Mar  1 18:11:06 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_50GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers50GeV_h
#define TwentyLayers50GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers50GeV(TTree *tree=0);
   virtual ~TwentyLayers50GeV();
...
#ifdef TwentyLayers50GeV_cxx
TwentyLayers50GeV::TwentyLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_50GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_50GeV.root");
      }
...
TwentyLayers50GeV::~TwentyLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers50GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers50GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers50GeV::Notify()
{
...
void TwentyLayers50GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers50GeV_cxx
