#define TwelveLayers50GeV_cxx
#include "TwelveLayers50GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
{  // CALO ANALYSIS 
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 50 GeV Electron Beam (12 Layers); Energy [GeV]; #Clusters",150,0,60);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_50GeV_12Layers_BOUND.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_50GeV_12layers_BOUND.pdf");
