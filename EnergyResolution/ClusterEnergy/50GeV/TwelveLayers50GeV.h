...
// Mon Mar  1 18:05:53 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_50GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers50GeV_h
#define TwelveLayers50GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers50GeV(TTree *tree=0);
   virtual ~TwelveLayers50GeV();
...
#ifdef TwelveLayers50GeV_cxx
TwelveLayers50GeV::TwelveLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_50GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_50GeV.root");
      }
...
TwelveLayers50GeV::~TwelveLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers50GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers50GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers50GeV::Notify()
{
...
void TwelveLayers50GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers50GeV_cxx
