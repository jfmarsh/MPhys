...
// Mon Mar  1 18:05:16 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_50GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers50GeV_h
#define FourLayers50GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers50GeV(TTree *tree=0);
   virtual ~FourLayers50GeV();
...
#ifdef FourLayers50GeV_cxx
FourLayers50GeV::FourLayers50GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_50GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_50GeV.root");
      }
...
FourLayers50GeV::~FourLayers50GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers50GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers50GeV::LoadTree(Long64_t entry)
{
...
void FourLayers50GeV::Init(TTree *tree)
{
...
void FourLayers50GeV::Show(Long64_t entry)
{
...
Int_t FourLayers50GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers50GeV_cxx
