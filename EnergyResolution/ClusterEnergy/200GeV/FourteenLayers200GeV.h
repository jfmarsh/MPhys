...
// Sat Mar 13 15:57:44 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_200GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers200GeV_h
#define FourteenLayers200GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers200GeV(TTree *tree=0);
   virtual ~FourteenLayers200GeV();
...
#ifdef FourteenLayers200GeV_cxx
FourteenLayers200GeV::FourteenLayers200GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_200GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_200GeV_14layers.root");
      }
...
FourteenLayers200GeV::~FourteenLayers200GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers200GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers200GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers200GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers200GeV::Notify()
{
...
void FourteenLayers200GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers200GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers200GeV_cxx
