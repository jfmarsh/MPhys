...
// Tue Mar  2 10:36:53 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_200GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers200GeV_h
#define FourLayers200GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers200GeV(TTree *tree=0);
   virtual ~FourLayers200GeV();
...
#ifdef FourLayers200GeV_cxx
FourLayers200GeV::FourLayers200GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_200GeV.root");
      }
...
FourLayers200GeV::~FourLayers200GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers200GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers200GeV::LoadTree(Long64_t entry)
{
...
void FourLayers200GeV::Init(TTree *tree)
{
...
Bool_t FourLayers200GeV::Notify()
{
...
void FourLayers200GeV::Show(Long64_t entry)
{
...
Int_t FourLayers200GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers200GeV_cxx
