...
// Tue Mar  2 10:40:34 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_200GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers200GeV_h
#define TwentyLayers200GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers200GeV(TTree *tree=0);
   virtual ~TwentyLayers200GeV();
...
#ifdef TwentyLayers200GeV_cxx
TwentyLayers200GeV::TwentyLayers200GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_200GeV.root");
      }
...
TwentyLayers200GeV::~TwentyLayers200GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers200GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers200GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers200GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers200GeV::Notify()
{
...
void TwentyLayers200GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers200GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers200GeV_cxx
