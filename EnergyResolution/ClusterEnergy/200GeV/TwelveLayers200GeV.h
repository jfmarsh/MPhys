...
// Tue Mar  2 10:37:42 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_200GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers200GeV_h
#define TwelveLayers200GeV_h
...
class TwelveLayers200GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 5272;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 5272;
   ...
   TwelveLayers200GeV(TTree *tree=0);
   virtual ~TwelveLayers200GeV();
...
#ifdef TwelveLayers200GeV_cxx
TwelveLayers200GeV::TwelveLayers200GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_200GeV.root");
      }
...
TwelveLayers200GeV::~TwelveLayers200GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers200GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers200GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers200GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers200GeV::Notify()
{
...
void TwelveLayers200GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers200GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers200GeV_cxx
