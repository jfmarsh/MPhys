...
// Tue Mar  2 10:37:23 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_200GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers200GeV_h
#define EightLayers200GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers200GeV(TTree *tree=0);
   virtual ~EightLayers200GeV();
...
#ifdef EightLayers200GeV_cxx
EightLayers200GeV::EightLayers200GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_200GeV.root");
      }
...
EightLayers200GeV::~EightLayers200GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers200GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers200GeV::LoadTree(Long64_t entry)
{
...
void EightLayers200GeV::Init(TTree *tree)
{
...
Bool_t EightLayers200GeV::Notify()
{
...
void EightLayers200GeV::Show(Long64_t entry)
{
...
Int_t EightLayers200GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers200GeV_cxx
