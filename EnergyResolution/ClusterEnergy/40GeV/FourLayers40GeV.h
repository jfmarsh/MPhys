...
// Sat Mar 13 13:35:06 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_40GeV_4layers.root
//////////////////////////////////////////////////////////

#ifndef FourLayers40GeV_h
#define FourLayers40GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers40GeV(TTree *tree=0);
   virtual ~FourLayers40GeV();
...
#ifdef FourLayers40GeV_cxx
FourLayers40GeV::FourLayers40GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_40GeV_4layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_40GeV_4layers.root");
      }
...
FourLayers40GeV::~FourLayers40GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers40GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers40GeV::LoadTree(Long64_t entry)
{
...
void FourLayers40GeV::Init(TTree *tree)
{
...
void FourLayers40GeV::Show(Long64_t entry)
{
...
Int_t FourLayers40GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers40GeV_cxx
