...
// Sat Mar 13 13:35:37 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_40GeV_12layers.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers40GeV_h
#define TwelveLayers40GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers40GeV(TTree *tree=0);
   virtual ~TwelveLayers40GeV();
...
#ifdef TwelveLayers40GeV_cxx
TwelveLayers40GeV::TwelveLayers40GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_40GeV_12layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_40GeV_12layers.root");
      }
...
TwelveLayers40GeV::~TwelveLayers40GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers40GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers40GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers40GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers40GeV::Notify()
{
...
void TwelveLayers40GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers40GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers40GeV_cxx
