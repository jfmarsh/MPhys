...
// Sat Mar 13 13:35:22 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_40GeV_8layers.root
//////////////////////////////////////////////////////////

#ifndef EightLayers40GeV_h
#define EightLayers40GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers40GeV(TTree *tree=0);
   virtual ~EightLayers40GeV();
...
#ifdef EightLayers40GeV_cxx
EightLayers40GeV::EightLayers40GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_40GeV_8layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_40GeV_8layers.root");
      }
...
EightLayers40GeV::~EightLayers40GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers40GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers40GeV::LoadTree(Long64_t entry)
{
...
void EightLayers40GeV::Init(TTree *tree)
{
...
Bool_t EightLayers40GeV::Notify()
{
...
void EightLayers40GeV::Show(Long64_t entry)
{
...
Int_t EightLayers40GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers40GeV_cxx
