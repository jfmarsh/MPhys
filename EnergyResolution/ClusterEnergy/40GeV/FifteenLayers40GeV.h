...
// Sat Mar 13 17:05:52 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_40GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers40GeV_h
#define FifteenLayers40GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FifteenLayers40GeV(TTree *tree=0);
   virtual ~FifteenLayers40GeV();
...
#ifdef FifteenLayers40GeV_cxx
FifteenLayers40GeV::FifteenLayers40GeV(TTree *tree) : fChain(0) 
{
...
FifteenLayers40GeV::~FifteenLayers40GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers40GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers40GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers40GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers40GeV::Notify()
{
...
void FifteenLayers40GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers40GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers40GeV_cxx
