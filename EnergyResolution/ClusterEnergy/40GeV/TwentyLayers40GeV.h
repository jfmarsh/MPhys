...
// Sat Mar 13 14:15:33 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_40GeV_20layers.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers40GeV_h
#define TwentyLayers40GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers40GeV(TTree *tree=0);
   virtual ~TwentyLayers40GeV();
...
#ifdef TwentyLayers40GeV_cxx
TwentyLayers40GeV::TwentyLayers40GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_40GeV_20layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_40GeV_20layers.root");
      }
...
TwentyLayers40GeV::~TwentyLayers40GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers40GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers40GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers40GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers40GeV::Notify()
{
...
void TwentyLayers40GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers40GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers40GeV_cxx
