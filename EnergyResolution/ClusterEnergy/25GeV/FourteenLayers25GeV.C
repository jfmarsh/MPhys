#define FourteenLayers25GeV_cxx
#include "FourteenLayers25GeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
{  // CALO ANALYSIS 
   ...
   // HISTOGRAMS           
   // Cluster Energy
   TH1F *ClusterEnergy = new TH1F("clusterEnergy"," CaloCluster Energy for 25 GeV Electron Beam (14 Layers); Energy [GeV]; #Events",150,0,30);    
   ...
   // write to text file 
   ofstream NewerFile("ClusterEnergyFit_25GeV_14Layers.txt");
   NewerFile << mean << " " << mean_error << " " << sigma << " " << sigma_error << "\n\n";
   NewerFile.close();
   c1->SaveAs("ClusterEnergyFit_25GeV_14layers.pdf");
