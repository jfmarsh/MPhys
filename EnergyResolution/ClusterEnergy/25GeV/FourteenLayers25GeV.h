...
// Sat Mar 13 13:54:44 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_25GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers25GeV_h
#define FourteenLayers25GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers25GeV(TTree *tree=0);
   virtual ~FourteenLayers25GeV();
...
#ifdef FourteenLayers25GeV_cxx
FourteenLayers25GeV::FourteenLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_25GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_25GeV_14layers.root");
      }
...
FourteenLayers25GeV::~FourteenLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers25GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers25GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers25GeV::Notify()
{
...
void FourteenLayers25GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers25GeV_cxx
