...
// Mon Mar  1 15:58:57 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_12layers_25GeV.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers25GeV_h
#define TwelveLayers25GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwelveLayers25GeV(TTree *tree=0);
   virtual ~TwelveLayers25GeV();
...
#ifdef TwelveLayers25GeV_cxx
TwelveLayers25GeV::TwelveLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_12layers_25GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_12layers_25GeV.root");
      }
...
TwelveLayers25GeV::~TwelveLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers25GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers25GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers25GeV::Notify()
{
...
void TwelveLayers25GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers25GeV_cxx
