...
// Mon Mar  1 15:59:37 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_20layers_25GeV.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers25GeV_h
#define TwentyLayers25GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TwentyLayers25GeV(TTree *tree=0);
   virtual ~TwentyLayers25GeV();
...
#ifdef TwentyLayers25GeV_cxx
TwentyLayers25GeV::TwentyLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_20layers_25GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_20layers_25GeV.root");
      }
...
TwentyLayers25GeV::~TwentyLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers25GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers25GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers25GeV::Notify()
{
...
void TwentyLayers25GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers25GeV_cxx
