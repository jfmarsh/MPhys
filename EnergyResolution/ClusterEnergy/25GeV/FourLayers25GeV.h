...
// Mon Mar  1 15:58:22 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_4layers_25GeV.root
//////////////////////////////////////////////////////////

#ifndef FourLayers25GeV_h
#define FourLayers25GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers25GeV(TTree *tree=0);
   virtual ~FourLayers25GeV();
...
#ifdef FourLayers25GeV_cxx
FourLayers25GeV::FourLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_4layers_25GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_4layers_25GeV.root");
      }
...
FourLayers25GeV::~FourLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers25GeV::LoadTree(Long64_t entry)
{
...
void FourLayers25GeV::Init(TTree *tree)
{
...
void FourLayers25GeV::Show(Long64_t entry)
{
...
Int_t FourLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers25GeV_cxx
