...
// Mon Mar  1 15:58:39 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_8layers_25GeV.root
//////////////////////////////////////////////////////////

#ifndef EightLayers25GeV_h
#define EightLayers25GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EightLayers25GeV(TTree *tree=0);
   virtual ~EightLayers25GeV();
...
#ifdef EightLayers25GeV_cxx
EightLayers25GeV::EightLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_8layers_25GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_8layers_25GeV.root");
      }
...
EightLayers25GeV::~EightLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers25GeV::LoadTree(Long64_t entry)
{
...
void EightLayers25GeV::Init(TTree *tree)
{
...
Bool_t EightLayers25GeV::Notify()
{
...
void EightLayers25GeV::Show(Long64_t entry)
{
...
Int_t EightLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers25GeV_cxx
