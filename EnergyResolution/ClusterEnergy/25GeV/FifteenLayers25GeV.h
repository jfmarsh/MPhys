...
// Mon Mar  1 15:59:17 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_15layers_25GeV.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers25GeV_h
#define FifteenLayers25GeV_h
...
class FifteenLayers25GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 1535;
   ...
   static constexpr Int_t kMaxECalBarrelCells = 1535;
   ...
   FifteenLayers25GeV(TTree *tree=0);
   virtual ~FifteenLayers25GeV();
...
#ifdef FifteenLayers25GeV_cxx
FifteenLayers25GeV::FifteenLayers25GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_15layers_25GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_15layers_25GeV.root");
      }
...
FifteenLayers25GeV::~FifteenLayers25GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers25GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers25GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers25GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers25GeV::Notify()
{
...
void FifteenLayers25GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers25GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers25GeV_cxx
