...
// Sat Mar 13 16:23:17 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_300GeV_14layers.root
//////////////////////////////////////////////////////////

#ifndef FourteenLayers300GeV_h
#define FourteenLayers300GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourteenLayers300GeV(TTree *tree=0);
   virtual ~FourteenLayers300GeV();
...
#ifdef FourteenLayers300GeV_cxx
FourteenLayers300GeV::FourteenLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_300GeV_14layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_300GeV_14layers.root");
      }
...
FourteenLayers300GeV::~FourteenLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourteenLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourteenLayers300GeV::LoadTree(Long64_t entry)
{
...
void FourteenLayers300GeV::Init(TTree *tree)
{
...
Bool_t FourteenLayers300GeV::Notify()
{
...
void FourteenLayers300GeV::Show(Long64_t entry)
{
...
Int_t FourteenLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourteenLayers300GeV_cxx
