...
// Thu Mar 11 12:50:07 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noiseFromFile_300GeV_8layers.root
//////////////////////////////////////////////////////////

#ifndef EightLayers300GeV_h
#define EightLayers300GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 985600;
   static constexpr Int_t kMaxCaloClusters = 1;
   ...
   EightLayers300GeV(TTree *tree=0);
   virtual ~EightLayers300GeV();
...
#ifdef EightLayers300GeV_cxx
EightLayers300GeV::EightLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noiseFromFile_300GeV_8layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noiseFromFile_300GeV_8layers.root");
      }
...
EightLayers300GeV::~EightLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EightLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EightLayers300GeV::LoadTree(Long64_t entry)
{
...
void EightLayers300GeV::Init(TTree *tree)
{
...
Bool_t EightLayers300GeV::Notify()
{
...
void EightLayers300GeV::Show(Long64_t entry)
{
...
Int_t EightLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef EightLayers300GeV_cxx
