...
// Thu Mar 11 13:10:07 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noiseFromFile_300GeV_15layers.root
//////////////////////////////////////////////////////////

#ifndef FifteenLayers300GeV_h
#define FifteenLayers300GeV_h
...
class FifteenLayers300GeV {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmergedECalCells = 6478;
   static constexpr Int_t kMaxemptyCaloCells = 1;
   static constexpr Int_t kMaxmergedECalCellsNoise = 1836736;
   static constexpr Int_t kMaxCaloClusters = 4;
   static constexpr Int_t kMaxCaloClusters0 = 1;
   static constexpr Int_t kMaxECalBarrelCells = 6478;
   ...
   FifteenLayers300GeV(TTree *tree=0);
   virtual ~FifteenLayers300GeV();
...
#ifdef FifteenLayers300GeV_cxx
FifteenLayers300GeV::FifteenLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noiseFromFile_300GeV_15layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noiseFromFile_300GeV_15layers.root");
      }
...
FifteenLayers300GeV::~FifteenLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FifteenLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FifteenLayers300GeV::LoadTree(Long64_t entry)
{
...
void FifteenLayers300GeV::Init(TTree *tree)
{
...
Bool_t FifteenLayers300GeV::Notify()
{
...
void FifteenLayers300GeV::Show(Long64_t entry)
{
...
Int_t FifteenLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FifteenLayers300GeV_cxx
