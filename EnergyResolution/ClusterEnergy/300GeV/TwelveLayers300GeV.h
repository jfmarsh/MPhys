...
// Thu Mar 11 13:00:47 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noiseFromFile_300GeV_12layers.root
//////////////////////////////////////////////////////////

#ifndef TwelveLayers300GeV_h
#define TwelveLayers300GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 1472768;
   ...
   TwelveLayers300GeV(TTree *tree=0);
   virtual ~TwelveLayers300GeV();
...
#ifdef TwelveLayers300GeV_cxx
TwelveLayers300GeV::TwelveLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noiseFromFile_300GeV_12layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noiseFromFile_300GeV_12layers.root");
      }
...
TwelveLayers300GeV::~TwelveLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwelveLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwelveLayers300GeV::LoadTree(Long64_t entry)
{
...
void TwelveLayers300GeV::Init(TTree *tree)
{
...
Bool_t TwelveLayers300GeV::Notify()
{
...
void TwelveLayers300GeV::Show(Long64_t entry)
{
...
Int_t TwelveLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwelveLayers300GeV_cxx
