...
// Thu Mar 11 12:24:37 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noiseFromFile_300GeV_4layers.root
//////////////////////////////////////////////////////////

#ifndef FourLayers300GeV_h
#define FourLayers300GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FourLayers300GeV(TTree *tree=0);
   virtual ~FourLayers300GeV();
...
#ifdef FourLayers300GeV_cxx
FourLayers300GeV::FourLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noiseFromFile_300GeV_4layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noiseFromFile_300GeV_4layers.root");
      }
...
FourLayers300GeV::~FourLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t FourLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FourLayers300GeV::LoadTree(Long64_t entry)
{
...
void FourLayers300GeV::Init(TTree *tree)
{
...
Bool_t FourLayers300GeV::Notify()
{
...
void FourLayers300GeV::Show(Long64_t entry)
{
...
Int_t FourLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef FourLayers300GeV_cxx
