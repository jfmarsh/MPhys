...
// Thu Mar 11 14:01:41 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noiseFromFile_300GeV_20layers.root
//////////////////////////////////////////////////////////

#ifndef TwentyLayers300GeV_h
#define TwentyLayers300GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 2438656;
   ...
   TwentyLayers300GeV(TTree *tree=0);
   virtual ~TwentyLayers300GeV();
...
#ifdef TwentyLayers300GeV_cxx
TwentyLayers300GeV::TwentyLayers300GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noiseFromFile_300GeV_20layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noiseFromFile_300GeV_20layers.root");
      }
...
TwentyLayers300GeV::~TwentyLayers300GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TwentyLayers300GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TwentyLayers300GeV::LoadTree(Long64_t entry)
{
...
void TwentyLayers300GeV::Init(TTree *tree)
{
...
Bool_t TwentyLayers300GeV::Notify()
{
...
void TwentyLayers300GeV::Show(Long64_t entry)
{
...
Int_t TwentyLayers300GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef TwentyLayers300GeV_cxx
