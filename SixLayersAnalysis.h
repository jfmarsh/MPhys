...
// Fri Feb  5 17:51:36 2021 by ROOT version 6.22/02
// from TTree events/Events tree
// found on file: output_allCalo_reco_noise_6layers.root
//////////////////////////////////////////////////////////

#ifndef SixLayersAnalysis_h
#define SixLayersAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxmergedECalCellsNoise = 737792;
   ...
   SixLayersAnalysis(TTree *tree=0);
   virtual ~SixLayersAnalysis();
...
#ifdef SixLayersAnalysis_cxx
SixLayersAnalysis::SixLayersAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_allCalo_reco_noise_6layers.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_allCalo_reco_noise_6layers.root");
      }
...
SixLayersAnalysis::~SixLayersAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SixLayersAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SixLayersAnalysis::LoadTree(Long64_t entry)
{
...
void SixLayersAnalysis::Init(TTree *tree)
{
...
Bool_t SixLayersAnalysis::Notify()
{
...
void SixLayersAnalysis::Show(Long64_t entry)
{
...
Int_t SixLayersAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SixLayersAnalysis_cxx
